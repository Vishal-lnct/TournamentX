    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("role", models.CharField(choices=[("organizer", "Organizer"), ("team", "Team Captain / Player")], default="team", max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("match_format", models.CharField(choices=[("T20", "T20"), ("ODI", "ODI"), ("TEST", "Test"), ("T10", "T10"), ("CUSTOM", "Custom")], default="T20", max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("captain", models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name="tournament_registrations", to=settings.AUTH_USER_MODEL)),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=("tournament", "captain"), name="unique_registration_per_captain_per_tournament"),
        ),
    ]
